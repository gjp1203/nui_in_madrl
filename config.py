...
class Config(object):
    ...
    class Experience_Replay_Memory_Config(object):
        ...
        def __init__(self):
            ...
            self.__threshold     = 150              # Learning threshold
    ...
    class Fully_Connected_Feature_Extractors(object):
        ...
        def __init__(self):
            self.__layers   = [400,300] # List specifying size of each layer
    ...
    class DDPG_Config(object):
        ...
        def __init__(self):
            ...
            self.__alr               = 0.0001       # Actor Learning Rate
    ...
    class NUI_Config(object):
        ...
        def __init__(self):
            ...
            self.__decay_threshold = 400   # Intervals are expanded after specified number of episodes
    ...
    class Leniency_Config(object):
        ...
        def __init__(self, method='TDS'):
            ...
            self.__hashing               = 'AutoEncoder'     # Options: xxhash, AutoEncoder, L2 (Layer2)
